...
export function StatsSection({ t, departmentsCount }: StatsSectionProps) {
  return (
    <section id="portal-content" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 scroll-mt-20">
      <div className="liyon-card grid grid-cols-2 lg:grid-cols-4 gap-6 p-8 rounded-[8px]">
